...
class UnionFrame(OperatorFrame):
    ...
    def __init__(self, parent, ocel_model, title, description):
        ...
        self.innerRightLayout.addWidget(self.numOfMatchesLabel, 6, 0)
    ...
    def getParameters(self):
        ...
        return {"name1" : name1, "name2" : name2, "respectObjRelations" : respectObjRelations, "mergeEvents" : mergeEvents, "matchOn" : matchOn}
    ...
    def getNewLog(self, newName, parameters={}):
        ...
        respectObjRelations = parameters["respectObjRelations"]
        mergeEvents = parameters["mergeEvents"]
        matchOn = parameters["matchOn"]

        return self.ocel_model.union(name1, name2, matchOn=matchOn, respectObjRelations=respectObjRelations, mergeEvents=mergeEvents, newName=newName)
